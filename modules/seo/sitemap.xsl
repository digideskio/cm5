<?xml version="1.0" encoding="UTF-8"?><xsl:stylesheet version="2.0" xmlns:html="http://www.w3.org/TR/REC-html40" xmlns:sitemap="http://www.sitemaps.org/schemas/sitemap/0.9" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="/">
		<html xmlns="http://www.w3.org/1999/xhtml">
			...
			<body>
				...
				<div id="footer">
					Generated by <em>S.E.O. Plugin</em> running on <strong>phplibs CMS</strong>.
				</div>
			</body>
		</html>
	</xsl:template>
